...
<body>
    <div class="bluebox" style="padding: 20px;">
        <form action="home.php" method="post">
            ...
            <button type="button" class="btn" onclick="addSkill()">Add Skill</button><br>
            ...
            <button type="button"  class="btn" onclick="addBenefit()">Add Benefit</button><br>
            <ul id="selectedBenefits" name="selectedBenefits"></ul>
            
            <button type="submit"  class="btn">Submit</button>
            <button onclick="window.location.href='home.php';"  class="btn">Cancel</button>
        </form>
    </div>
