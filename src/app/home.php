...
<body>  
  <div style="width: 100%">  
  <div class="bluebox" style="padding: 20px;">
      ...
      <div id="jobseekers" style="display: none">
          <form method="GET" style="display: flex; align-items: center;">
              ...
              <!-- <button type="submit" style="background: none; border: none; padding: 0; margin: 0; cursor: pointer; align-self: stretch;"> -->
              <button type="submit" style="background: none; border: none; padding: 0; margin: 0; cursor: pointer; vertical-align: middle;">
